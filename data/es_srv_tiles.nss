...
void Tiles_Load(string sServiceScript)
{
    ...
    Tiles_ProcessTileset("Tds01");
    Tiles_ProcessTileset("Tds01");
    Tiles_ProcessTileset("Tms01");
    Tiles_ProcessTileset("Ttf01");
    Tiles_ProcessTileset("Dag01");
    Tiles_ProcessTileset("Tcm02");
    Tiles_ProcessTileset("Trm02");
    Tiles_ProcessTileset("Trs02");
    Tiles_ProcessTileset("Tss13");
    Tiles_ProcessTileset("Ttf02");
    Tiles_ProcessTileset("Tts02");
    Tiles_ProcessTileset("Tib01");
    Tiles_ProcessTileset("Tid01");
    Tiles_ProcessTileset("Tin01");
    Tiles_ProcessTileset("Ttu01");
    Tiles_ProcessTileset("Tcn01");
    Tiles_ProcessTileset("Tde01");
    Tiles_ProcessTileset("Tdm01");
    Tiles_ProcessTileset("Tdr01");
    Tiles_ProcessTileset("Tic01");
    Tiles_ProcessTileset("Tii01");
    Tiles_ProcessTileset("Ttd01");
    Tiles_ProcessTileset("Tti01");
    Tiles_ProcessTileset("Ttr01");
    Tiles_ProcessTileset("Tts01");
    Tiles_ProcessTileset("Tbw01");
    Tiles_ProcessTileset("Tdt01");
    Tiles_ProcessTileset("Tni01");
    Tiles_ProcessTileset("Tni01");
    Tiles_ProcessTileset("Tno01");
    Tiles_ProcessTileset("Tsw01");
    Tiles_ProcessTileset("Ttz01");
    Tiles_ProcessTileset("Twc03");
    Tiles_ProcessTileset("Trc01");
    Tiles_ProcessTileset("Aws01");
    Tiles_ProcessTileset("Dck01");
    Tiles_ProcessTileset("Dls01");
    Tiles_ProcessTileset("Dls10");
    Tiles_ProcessTileset("Drk01");
    Tiles_ProcessTileset("Eld01");
    Tiles_ProcessTileset("Eld02");
    Tiles_ProcessTileset("Eld05");
    Tiles_ProcessTileset("Ith01");
    Tiles_ProcessTileset("Pie23");
    Tiles_ProcessTileset("Tbm01");
    Tiles_ProcessTileset("Tcn01");
    Tiles_ProcessTileset("Tdcic");
    Tiles_ProcessTileset("Tde01");
    Tiles_ProcessTileset("Tdin1");
    Tiles_ProcessTileset("Tdlk1");
    Tiles_ProcessTileset("Tdm01");
    Tiles_ProcessTileset("Tdr01");
    Tiles_ProcessTileset("Tec01");
    Tiles_ProcessTileset("Tic01");
    Tiles_ProcessTileset("Tin01");
    Tiles_ProcessTileset("Tmp01");
    Tiles_ProcessTileset("Tmz01");
    Tiles_ProcessTileset("Trf01");
    Tiles_ProcessTileset("Tsh01");
    Tiles_ProcessTileset("Tsl02");
    Tiles_ProcessTileset("Ttf01");
    Tiles_ProcessTileset("Ttf02");
    Tiles_ProcessTileset("Ttlam");
    Tiles_ProcessTileset("Ttr01");
    Tiles_ProcessTileset("Ttu01");
    Tiles_ProcessTileset("Tvd01");
    Tiles_ProcessTileset("Tvh10");
    Tiles_ProcessTileset("Txd01");
    Tiles_ProcessTileset("Tzs01");
    Tiles_ProcessTileset("Tdx01");
    Tiles_ProcessTileset("TMD18C");
    Tiles_ProcessTileset("Tvd");
    Tiles_ProcessTileset("WDP01");
    Tiles_ProcessTileset("Wcc01");
    Tiles_ProcessTileset("Wlf01");
    Tiles_ProcessTileset("Wdd04");
    Tiles_ProcessTileset("Wms01");
    Tiles_ProcessTileset("Wsf10");
    Tiles_ProcessTileset("Wut01");
    Tiles_ProcessTileset("Tei01");
    Tiles_ProcessTileset("Tjj01");
